...
\begin{frame}{Invariant}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Identifies four possible queue states -- see next slide
    \end{itemize}
  \end{itemize}
...
\begin{frame}{Invariant (Queue States)}
  \begin{itemize}
    \item Two locks $\rightarrow$ four queue states: \StaticState, \EnqueueState, \DequeueState, and \BothState
