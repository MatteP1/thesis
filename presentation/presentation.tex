...
\begin{frame}
  \todo{create all slides}
\end{frame}

% SLIDE STRUCTURE

% Contributions
% - take from list in introduction
...
% + Concurrent clients and need for preconditions
% - seq
% - Conc
% - Hocap
% - Client
...
% TLMSQ satisfies HOCAP spec: proof
% - invariant
% - Queue predicate
% - Proof of init
% - Proof of enq xor deq
...
% LFMSQ
% - code
% - Illustrations (mention differences with TLMSQ)
...
% LCCFMSQ satisfies HOCAP spec: proof
% - reachability
% - Invariant
% - Queue predicate
% - Proof of init and (enq xor deq) in coq
% + go over contents of file, but skip swing tail proof, and many of the results about reachability.

% Resource Algebras (if time permits, otherwise mention definitions on slides where they are introduced)
