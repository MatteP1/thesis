...
\begin{frame}{Context}
  \begin{itemize}
    ...
    \item Success! – but not too interesting
    \pause
...
\begin{frame}{HOCAP derives Sequential}
  ...
  \begin{itemize}
    ...
    \item For dequeue, pick
      \begin{itemize}
        \item $P = \abstractstatefullfrag{\Qg.\gabst}{xs_v}$
        \item $Q = \abstractstatefullfrag{\Qg.\gabst}{[]} \lor (\exists v, xs_v'. xs_v = xs_v' \catenate [v] \star{} \abstractstatefullfrag{\Qg.\gabst}{xs_v'})$
      \end{itemize}
  \end{itemize}
