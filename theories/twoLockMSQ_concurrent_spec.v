...
Lemma queue_invariant_equiv_simple : ∀ Ψ l_head l_tail Q_γ,
...
(* ----- The 'is_queue' Predicate for Concurrent Spec ------ *)
...
Proof.
	...
	- (* Queue is non-empty*)
	  ...
	  apply list_last_eq in Hconc_abst_eq as [Hxs_rest_val_eq Hx_head_next_eq].
