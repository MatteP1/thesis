...
\begin{align*}
  ...
  &\land\quad\forall q, v, xs_v, Q_\gname. \hoare{\isqueue \; q \; xs_v \; Q_\gname}{\enqueue\ q\ v}{v . \isqueue\ q\ (v :: xs_v)\ Q_\gname}\\
...
\begin{align*}
  \isqueue \; q \; xs_v \; Q_\gname = &\exists l_{queue}, head, tail \in \Loc . \exists H_{lock}, T_{lock} \in \Val . \\
  &q = l_{queue} \ast l_{queue} \mapsto\persistently ((head, tail), (H_{lock}, T_{lock})) \ast\\
...
\begin{align*}
  ...
  &\quad\quad \forall v, Q_\gname . \isqueue \; v \; Q_\gname \implies \persistently \isqueue \; v \; Q_\gname\\
