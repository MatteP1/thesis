...
The later modality has many uses in Iris, but for our presentation, the Löb induction rule (\todo{ref Loeb}) is the most important. It states that if we can prove a proposition $P$ using $\later P$, then we can actually prove $P$ without $\later P$.
