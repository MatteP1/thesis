...
In this section, we look at an example queue client, named \textit{QueueAdd}. The example is somewhat contrived but illustrates the capabilities of the HOCAP-style specification, and the limitations of the concurrent and sequential specifications. \todo{write more}
\begin{figure}
