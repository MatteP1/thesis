...
\begin{align*}
  ...
  &\land{}\quad\concspecinit{\Phi}\\
  &\land{}\quad\concspecenq{\Phi}\\
  &\land{}\quad\concspecdeq{\Phi}
\end{align*}
\end{definition}
...
\begin{equation*}
  \seqspecenqGen{\vq}{\absvalue}{\absvalueList}{\Qgseq}
\end{equation*}
...
\begin{equation*}
  \hocapspecenqVS{\absvalue}{\Qghocap}{\abstractstatefullfrag{\Qghocap.\gabst}{\absvalueList}}{\abstractstatefullfrag{\Qghocap.\gabst}{(\absvalue :: \absvalueList)}}{\absvalueList'}
\end{equation*}
...
\begin{equation}
  \hocapspecenqHT{\vq}{\absvalue}{\Qghocap}{\abstractstatefullfrag{\Qghocap.\gabst}{\absvalueList}}{\abstractstatefullfrag{\Qghocap.\gabst}{(\absvalue :: \absvalueList)}}\label{QueueSpecs:spec:der:seq:proof:enq:hocap}
\end{equation}
...
\begin{equation*}
  \seqspecdeqGen{\vq}{\absvalueList}{\Qgconc}
\end{equation*}
...
\begin{equation*}
\hocapspecdeqVS{\Qghocap}{P}{Q}{\absvalueList'}
\end{equation*}
...
We must derive:
\begin{equation*}
  \concspecenqGen{\Phi}{\vq}{\absvalue}{\Qgconc}
\end{equation*}
...
\begin{equation*}
  \hocapspecenqVS{\absvalue}{\Qghocap}{\Psi(\absvalue)}{\TRUE}{\absvalueList'}
\end{equation*}
